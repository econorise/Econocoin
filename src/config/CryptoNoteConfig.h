...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x2f32e0;
    ...
    const char CRYPTONOTE_NAME[] = "EconoCoin";
    ...
    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb4, 0x0c, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc1, 0x43, 0xe9}};

    const char *const SEED_NODES[] = {
        "40.76.82.155:8545", // LJETH
        "13.72.69.66:8545", // LJETH2
    };
} // namespace CryptoNote
